...
const Referrals = () => {
    ...
    return (
        <div className='referrals'>
            <BackArrowHeading title="Referrals" link="settings" />
            <div className='referral-content'>
                <p>Invite your friends using your invite link below and earn commission on every payment.</p>
                ...
                <div className="referral-social-link">
